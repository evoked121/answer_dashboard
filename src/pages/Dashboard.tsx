...
const Dashboard = () => {
  ...
  const [cards, setCards] = useState([
    { id: 1, content: "split", isSelected: false },
    { id: 2, content: "split1", isSelected: false },
  ]);
  ...
  // const reli = testdata.map((item) => {
  //   return { ...item, content2: "eee" };
  // });
  // const r = reli.filter((item) => {
  //   return item.id === 1;
  // });
  // console.log(reli);
  // console.log(r);
  return (
    ...
    //   </Drawer>
    // </>
    <div className="flex flex-row bg-[#DDDDDD] h-full w-full">
      <div className="flex flex-col bg-[#FF44AA] justify-center items-center w-[80px]">
        <div>test</div>
        <div>test2</div>
      </div>
    </div>
